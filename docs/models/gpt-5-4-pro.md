...
<div class="model-profile" aria-label="Model availability profile">
    <div class="model-profile__main">
        ...
        <p class="model-profile__lead">Available in <strong>4</strong> of <strong>32</strong> tracked regions with <strong>4</strong> deployment SKU types.</p>
    ...
    <div class="model-profile__insight">
        ...
        <small>4 regions · 12% coverage · Other</small>
    </div>
</div>
