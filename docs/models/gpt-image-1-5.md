...
<div class="model-profile" aria-label="Model availability profile">
    <div class="model-profile__main">
        ...
        <p class="model-profile__lead">Available in <strong>5</strong> of <strong>92</strong> tracked regions with <strong>4</strong> deployment SKU types.</p>
    ...
    <div class="model-profile__insight">
        ...
        <small>5 regions · 5% coverage · Other</small>
    </div>
</div>
    ...
    <div class="deployment-lane__body">
        ...
        <div class="deployment-sku-row">
            <div class="deployment-sku-row__copy">
                ...
                <span>5 regions · 5% coverage</span>
            </div>
            <div class="availability-meter" aria-hidden="true"><span style="width: 5%;"></span></div>
        </div>
        <div class="deployment-sku-row">
            <div class="deployment-sku-row__copy">
