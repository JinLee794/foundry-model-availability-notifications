...
<div class="model-profile" aria-label="Model availability profile">
    <div class="model-profile__main">
        ...
        <p class="model-profile__lead">Available in <strong>3</strong> of <strong>92</strong> tracked regions with <strong>2</strong> deployment SKU types.</p>
    ...
    <div class="model-profile__insight">
        ...
        <small>3 regions · 3% coverage · Standard</small>
    </div>
</div>
    ...
    <div class="deployment-lane__body">
        ...
        <div class="deployment-sku-row">
            <div class="deployment-sku-row__copy">
                ...
                <span>3 regions · 3% coverage</span>
            </div>
